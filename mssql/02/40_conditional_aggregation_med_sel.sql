...
-- Description: 
---------------
-- The test compare a conditional aggregation query with a query using subquery with distinct. 
-- This test uses a medium selectivity condition in the predicate (50% of rows per group).
